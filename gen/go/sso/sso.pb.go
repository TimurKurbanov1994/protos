...
type IsAdminResponse struct {
	state         protoimpl.MessageState `protogen:"open.v1"`
	IsAdmin       int32                  `protobuf:"varint,1,opt,name=is_admin,json=isAdmin,proto3" json:"is_admin,omitempty"`
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}
...
func (x *IsAdminResponse) GetIsAdmin() int32 {
	if x != nil {
		return x.IsAdmin
	}
	return 0
...
const file_sso_sso_proto_rawDesc = "" +
	...
	"\bis_admin\x18\x01 \x01(\x05R\aisAdmin2\xab\x01\n" +
	"\x04Auth\x129\n" +
	"\bRegister\x12\x15.auth.RegisterRequest\x1a\x16.auth.RegisterResponse\x120\n" +
	"\x05Login\x12\x12.auth.LoginRequest\x1a\x13.auth.LoginResponse\x126\n" +
	"\aIsAdmin\x12\x14.auth.IsAdminRequest\x1a\x15.auth.IsAdminResponseB\x12Z\x10tuzov.sso.v1;ssob\x06proto3"
